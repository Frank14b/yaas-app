...
export function ViolenceDetails({ item, isAdmin }: ViolenceDetailsProps) {
  //
  ...
  return (
    <>
      <ThemedView style={styles.container}>
        ...
        <ThemedView style={[styles.lineContainer, dynamicStyles.lineContainer]}>
          <ThemedText style={styles.lineTextKey}>
            {t("violences.details.date_occurred")}
          </ThemedText>
          <ThemedText style={styles.lineText}>
        ...
        <ThemedView style={[styles.lineContainer, dynamicStyles.lineContainer]}>
          <ThemedText style={styles.lineTextKey}>
            {t("violences.details.date_created")}
          </ThemedText>
          <ThemedText style={styles.lineText}>
      ...
      {isAdmin && (
        <ThemedView style={styles.containerFooter}>
          <ThemedButton
            ...
            onPress={() =>
              router.push(`(forms)/investigation?noticeId=${item.id}` as Href)
            }
