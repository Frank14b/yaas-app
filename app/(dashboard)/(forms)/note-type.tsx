...
export default function NoteTypeFormScreen() {
  //
  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedInput
        name="name"
        label={t("noteTypes.form.fields.name")}
        placeholder={t("noteTypes.form.fields.name_placeholder")}
      />
      <ThemedInput
        name="details"
        label={t("noteTypes.form.fields.details")}
        placeholder={t("noteTypes.form.fields.details_placeholder")}
      />
      <ThemedButton
        title={t("noteTypes.form.submit_btn")}
